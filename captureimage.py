...
Label(root,text="Enter employ detail", font=("helvatica",40),bg="#F44336", fg="#0a0800").grid(rowspan=2,columnspan=2,sticky=N+E+W+S,padx=5,pady=5)

Label(root, text="Enter EID: ",fg="#42A5F5",bg="#795548",font=("chiller",20)).grid(row=3,padx=5,pady=5,sticky=E)
