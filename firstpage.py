...
def function3():
    os.system("C:/Users/akhil/Desktop/attendance-management-using-face-recognition/face/command.py")
...
Button(root,text="Employ LOGIN",font=("times new roman",30),bg="#3F51B5",fg='white',command=function2).grid(row=4,columnspan=2,sticky=N+E+W+S,padx=5,pady=5)
